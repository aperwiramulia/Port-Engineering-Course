# Lecture 8: Fender and Mooring Systems

Use this file as a copy-paste source for PowerPoint/Canva.

## Slide 1 - Lecture 8: Fender and Mooring Systems
- Port Engineering Course
- Keeping ships safely off the berth and securely in position alongside
- Focus: fender functions, mooring arrangement, hardware, design checks, and operational reliability
- Speaker cue: This lecture moves from berth structure concept into the interface system that actually manages ship impact and line restraint.

## Slide 2 - Learning Outcomes
- Explain how fender and mooring systems work together as one berth-interface system
- Compare common fender types and identify where each is typically used
- Describe the main mooring-line functions and the berth hardware that supports them
- Recognize the design checks that govern berth operability, line loads, and structural demand
- Speaker cue: Students should leave able to discuss both the hardware and the design logic behind a safe berth.

## Slide 3 - Why This Lecture Matters
- A strong quay wall still fails operationally if the vessel contacts it directly or cannot be held in position
- Poor fender choice can overload the structure or damage the ship hull
- Poor mooring layout increases vessel motion, line failure risk, cargo-transfer interruption, and downtime
- Speaker cue: Berthing safety and mooring safety are performance issues, not only equipment issues.

## Slide 4 - The Berth Interface System
- Quay or dolphin structure provides the load path
- Fender system absorbs berthing energy and spreads contact pressure
- Mooring system restrains the vessel under wind, current, wave drift, and passing-ship effects
- The whole system must be checked together, not as isolated components
- Speaker cue: Energy absorption, line restraint, and structural transfer are linked.

## Slide 5 - Core Fender Performance Terms
- Energy absorption: impact energy the unit can safely absorb
- Reaction force: load transferred back into the ship and berth structure
- Deflection or stroke: allowable compression range of the fender unit
- Contact pressure: local hull pressure controlled through panels and facing pads
- Speaker cue: Fender selection is never energy-only; reaction and contact conditions matter equally.

## Slide 6 - Common Fender Families
- Cell fenders: high energy, common for larger commercial berths
- Cone fenders: high energy efficiency with relatively stable reaction behavior
...
- Steel frontal panels distribute load over a larger hull contact area
- UHMW-PE pads reduce friction and protect hull coating
...
- Line loads, winch limits, and hook release capacities are compatible
...
- Reliable berth design checks energy, reaction, line force, motion, and structural transfer together
- Speaker cue: A berth is safe only when fender, mooring, and structural systems perform as one integrated interface.

## Backup Slide A - Fast Fender Comparison

### Cell / Cone
- High-energy commercial berths
- Usually paired with frontal panels
- Require careful reaction and anchorage checks

### Arch / Cylindrical
- Simpler and rugged
- Useful for smaller berths and utility applications
- Lower energy performance for large commercial vessels

### Pneumatic
- Floating and flexible
- Good for temporary, offshore, or ship-to-ship interfaces
- Requires pressure management and marine handling discipline

## Backup Slide B - 5-Question Review
- Why is fender selection not an energy-only decision?
- Which lines mainly control sway?
- Why might mooring dolphins be needed at a tanker berth?
- What happens if line angles become too steep with tidal change?
- Which checks link mooring hardware back to the berth structure?